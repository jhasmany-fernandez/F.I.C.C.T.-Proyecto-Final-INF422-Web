...
const menuItems = [
  ...
  { label: "Regentes", href: "/regentes", icon: UserCog },
  ...
  { label: "Monitoreo de Cámaras", href: "/monitoreo-camaras", icon: Cctv },
  { label: "Detección de Bullying", href: "/simulacion-bullying", icon: AlertTriangle },
  { label: "Control de Ingreso", href: "/control-ingreso", icon: FileText },
  { label: "Control de Salida", href: "/control-salida", icon: FileText },
  { label: "Asistencias", href: "/asistencias", icon: FileText },
  { label: "Historial de Salidas", href: "/historial-salidas", icon: FileText },
